...
public:
    ...
    p_node LF(sa_node N){
        ...
        std::cout << "First A: " << N.first_A << std::endl;
        std::cout << "First C: " << N.first_C << std::endl;
        std::cout << "First G: " << N.first_G << std::endl;
        std::cout << "First T: " << N.first_T << std::endl;
    ...
    void next_nodes(sa_node & N, vector<sa_node> & TMP_NODES, int & t){
        ...
        std::cout << "-A " << A.depth << " - " << A.first_TERM << " - " << A.last << std::endl;
        sa_node C = left_exts.C;
        std::cout << "-C " << C.depth << " - " << C.first_TERM << " - " << C.last << std::endl;
        sa_node G = left_exts.G;
        std::cout << "-G " << G.depth << " - " << G.first_TERM << " - " << G.last << std::endl;
        sa_node T = left_exts.T;
        std::cout << "-T " << T.depth << " - " << T.first_TERM << " - " << T.last << std::endl;
